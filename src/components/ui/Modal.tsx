      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className={`relative w-full ${maxWStyles[maxWidth]} bg-[#0d121b] border border-cyan-500/30 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-10 overflow-hidden my-8`}
          >
            {/* Ambient cyber top glow line */}
            <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-80" />

            {/* Header */}
            <div className="flex items-start justify-between p-5 border-b border-white/[0.08] bg-[#090d14]/60">
              <div>
